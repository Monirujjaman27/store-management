      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item  {{request()->is('products*') || request()->is('product-category*') ? 'open active' :''}}">
            ...
            <ul class="menu-sub">
              <li class="menu-item {{Request::route()->getName() == 'products.create' ? 'active':''}}">
                <a href="{{route('products.create')}}" class="menu-link">
                  <div>New Product</div>
                </a>
              </li>
              <li class="menu-item {{Request::route()->getName() == 'products.index' ? 'active':''}}">
            ...
            <div class="container-xxl">
              <div class="footer-container d-flex align-items-center justify-content-between py-2 flex-md-row flex-column">
                <div>
                  ...
                  , Developer by ❤️ Md Munirujjaman
                </div>
                <div class="d-none d-lg-inline-block">
                  <a href="https://monisoft.xyz/" class="footer-link me-4" target="_blank">Portfolios</a>
                  <a href="https://monisoft.xyz/#projects" target="_blank" class="footer-link me-4">More Projects</a>
                  <a href="https://monisoft.xyz/#contact-form" target="_blank" class="footer-link d-none d-sm-inline-block">Support</a>
                </div>
              </div>
            </div>
          </footer>
