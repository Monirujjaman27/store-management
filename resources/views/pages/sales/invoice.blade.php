...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row invoice-preview">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center ps-2 py-4">
                                        <a onclick="return confirm('Are you sure to delete')" href="{{route('delete_sale_item', $p_item->id)}}" class="btn btn-sm btn-danger text-danger"><i class="bi bi-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                <tr>
        ...
        <div class="col-xl-3 col-md-4 col-12 invoice-actions">
            <div class="card">
                <div class="card-body">
                    <a class="btn btn-label-secondary d-grid w-100 mb-2" target="_blank" href='{{route("sale_print_invoice", $data->id)}}'>
                        Print
                    </a>
